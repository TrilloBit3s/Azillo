...
public class PASSOS : MonoBehaviour 
{
	...
	public float TempoMadeira = 0.6f,TempoGrama = 0.6f,TempoTerra = 0.6f,TempoCimento = 0.6f,TempoMetal = 0.9f,TempoAgua = 0.6f,TempoPulo = 0.6f,TempoPadrao = 0.6f,Aceleracao = 1.3f;
